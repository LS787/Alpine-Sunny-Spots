...
// Add location with full weather analysis
function addLocationByCoordinates(lat, lng, name) {
  if (locations.length >= 10) {
    alert('Maximum 10 locations allowed.');
    return;
  }
...
console.log('Complete Alpine Weather App script loaded successfully!');
